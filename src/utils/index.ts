 ...
 * @returns 解析后的DOM节点
 */
const safeStringToDOM = (htmlString: string): Node | null => {
 ...
 * @returns 解析后的DOM节点
 */
const legacyStringToDOM = (htmlString: string): Node | null => {
 ...
 * @returns 解析后的DOM节点
 */
const createDomContentFromString = (htmlString: string): HTMLElement => {
 ...
 */
export const createDomContent = (input: unknown): HTMLElement => {
  // 1. 如果已经是DOM元素，直接返回
